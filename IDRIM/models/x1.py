...
def Run(Relations_dict, SysParams_dict, Fit, time_points=time_points):
	...
	for j in range(I_points):
		...
		#print(j)
		Hopper = Core(I, Relations_dict, SysParams_dict, Fit) #Hopper is a dictionary as f:Core outputs a dictionary
